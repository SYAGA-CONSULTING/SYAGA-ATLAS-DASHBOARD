#!/usr/bin/env python3
"""
Créer une commande UPDATE_ALL vers v8.6
"""
import json
import requests
import base64
...
print("="*60)
print("🚀 CRÉATION COMMANDE UPDATE vers v8.6")
print("="*60)
...
command_data = {
    ...
    "Title": f"UPDATE_v8.6_FIX_{datetime.now().strftime('%H%M%S')}",
...
try:
    ...
    if response.status_code in [200, 201]:
        ...
        print("\n🎯 Les agents v8.4 vont maintenant:")
        print("   1. Détecter cette commande (URL fixée)")
        print("   2. Se mettre à jour vers v8.6")
        print("   3. Prouver que l'auto-update fonctionne !")
    else:
