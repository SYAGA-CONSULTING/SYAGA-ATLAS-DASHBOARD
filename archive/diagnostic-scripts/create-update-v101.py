#!/usr/bin/env python3
"""
Créer une commande UPDATE_ALL vers v10.1
"""
import json
import requests
import base64
...
print("="*60)
print("🚀 CRÉATION COMMANDE UPDATE v10.1 - TEST FINAL")
print("="*60)
...
command_data = {
    ...
    "Title": f"UPDATE_v10.1_TEST_{datetime.now().strftime('%H%M%S')}",
...
try:
    ...
    if response.status_code in [200, 201]:
        ...
        print("\n🎯 L'UPDATER v10.0 va :")
        print("   1. Détecter cette commande dans 1 minute")
        print("   2. Télécharger agent v10.1")
        print("   3. Arrêter la tâche agent")
        print("   4. Remplacer agent.ps1")
        print("   5. Relancer la tâche agent")
        print("\n✅ SI ÇA MARCHE, ON AURA ENFIN UN AUTO-UPDATE STABLE !")
    else:
