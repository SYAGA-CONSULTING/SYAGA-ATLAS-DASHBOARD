# ATLAS v11.1 - INSTALLATION PROPRE ET INTELLIGENTE
Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  ATLAS v11.1 - INSTALLATION" -ForegroundColor Cyan
Write-Host "  2 TÂCHES SÉPARÉES" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

$atlasPath = "C:\SYAGA-ATLAS"
$agentUrl = "https://white-river-053fc6703.2.azurestaticapps.net/public/agent-v11.1.ps1"
$updaterUrl = "https://white-river-053fc6703.2.azurestaticapps.net/public/updater-v11.1.ps1"
...
# Télécharger agent
Write-Host "[2/5] Telechargement agent v11.1..." -ForegroundColor Yellow
try {
...
# Télécharger updater
Write-Host "[3/5] Telechargement updater v11.1 INTELLIGENT..." -ForegroundColor Yellow
try {
...
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
Write-Host "Architecture v11.1 INTELLIGENTE installee:" -ForegroundColor Yellow
