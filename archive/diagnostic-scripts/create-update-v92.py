#!/usr/bin/env python3
"""
Créer une commande UPDATE_ALL vers v9.2
"""
import json
import requests
import base64
...
print("="*60)
print("🚀 CRÉATION COMMANDE UPDATE vers v9.2 (TEST AUTO)")
print("="*60)
...
command_data = {
    ...
    "Title": f"UPDATE_v9.2_AUTO_{datetime.now().strftime('%H%M%S')}",
...
try:
    ...
    if response.status_code in [200, 201]:
        ...
        print("   2. Télécharger v9.2 depuis Azure")
        print("   3. Se mettre à jour AUTOMATIQUEMENT")
        print("   4. Redémarrer en v9.2")
        print("\n✅ L'AUTO-UPDATE FONCTIONNE ENFIN !")
    else:
