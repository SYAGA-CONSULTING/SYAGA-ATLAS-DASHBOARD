# ATLAS v10.0 - INSTALLATION 2 TÂCHES SÉPARÉES
Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  ATLAS v10.0 - INSTALLATION" -ForegroundColor Cyan
Write-Host "  2 TÂCHES SÉPARÉES" -ForegroundColor Cyan
Write-Host "========================================" -ForegroundColor Cyan
Write-Host ""

$atlasPath = "C:\SYAGA-ATLAS"
$agentUrl = "https://white-river-053fc6703.2.azurestaticapps.net/public/agent-v10.0.ps1"
...
# Télécharger agent
Write-Host "[2/5] Telechargement agent v10.0..." -ForegroundColor Yellow
try {
...
# Télécharger updater
Write-Host "[3/5] Telechargement updater v10.0..." -ForegroundColor Yellow
try {
