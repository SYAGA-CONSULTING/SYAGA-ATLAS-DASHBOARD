# ATLAS v11.0 - INSTALLATION PROPRE ET INTELLIGENTE
Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  ATLAS v11.0 - INSTALLATION" -ForegroundColor Cyan
...
$updaterUrl = "https://white-river-053fc6703.2.azurestaticapps.net/public/updater-v11.0.ps1"
...
# Télécharger agent
Write-Host "[2/5] Telechargement agent v11.0..." -ForegroundColor Yellow
try {
...
# Télécharger updater
Write-Host "[3/5] Telechargement updater v11.0 INTELLIGENT..." -ForegroundColor Yellow
try {
...
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
Write-Host "Architecture v11.0 INTELLIGENTE installee:" -ForegroundColor Yellow
