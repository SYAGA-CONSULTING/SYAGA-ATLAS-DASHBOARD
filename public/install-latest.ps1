...
$LATEST_VERSION = "13.2"  # FIX TÂCHES PLANIFIÉES + TESTS CONTRÔLÉS
$LATEST_INSTALL_URL = "https://white-river-053fc6703.2.azurestaticapps.net/public/install-v13.2.ps1"
