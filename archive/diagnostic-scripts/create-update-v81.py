#!/usr/bin/env python3
"""
Créer une commande UPDATE_ALL vers v8.1
"""
import json
import requests
import base64
...
print("="*60)
print("🚀 CRÉATION COMMANDE UPDATE vers v8.1")
print("="*60)
...
try:
    ...
    if response.status_code in [200, 201]:
        ...
        print("\n🎯 L'agent v8.0 va détecter cette commande dans 1 minute")
        print("   et se mettre à jour automatiquement vers v8.1")
    else:
