#!/usr/bin/env python3
"""
Créer une commande UPDATE_ALL vers v8.3
"""
import json
import requests
import base64
...
print("="*60)
print("🚀 CRÉATION COMMANDE UPDATE vers v8.3")
print("="*60)
...
command_data = {
    ...
    "Title": f"UPDATE_v8.3_{datetime.now().strftime('%H%M%S')}",
...
try:
    ...
    if response.status_code in [200, 201]:
        ...
        print("\n🎯 Les agents v8.2 vont détecter cette commande dans 1 minute")
        print("   et se mettre à jour automatiquement vers v8.3")
    else:
