# ATLAS v10.3 - INSTALLATION 2 TÂCHES SÉPARÉES
Write-Host ""
Write-Host "========================================" -ForegroundColor Cyan
Write-Host "  ATLAS v10.3 - INSTALLATION" -ForegroundColor Cyan
...
# Télécharger agent
Write-Host "[2/5] Telechargement agent v10.3..." -ForegroundColor Yellow
try {
...
Write-Host "========================================" -ForegroundColor Green
Write-Host ""
Write-Host "Architecture v10.3 installee:" -ForegroundColor Yellow
