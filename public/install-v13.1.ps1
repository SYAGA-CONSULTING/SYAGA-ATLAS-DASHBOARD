# ════════════════════════════════════════════════════
# ATLAS v13.1 - INSTALLATION COMPLÈTE (CORRECTION FERMETURE)
# ════════════════════════════════════════════════════
...
try {
    ...
    Write-Host "[ERREUR] Démarrage tâches : $_" -ForegroundColor Red
}
...
Write-Host "====================================================" -ForegroundColor Cyan
Write-Host ""
Write-Host "Version installée : v$VERSION (correction fermeture)" -ForegroundColor White
