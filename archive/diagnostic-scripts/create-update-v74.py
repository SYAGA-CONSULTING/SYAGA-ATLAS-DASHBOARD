#!/usr/bin/env python3
"""
Créer une commande UPDATE_ALL dans SharePoint pour v7.4
"""
import json
import requests
import base64
...
print("="*60)
print("🚀 CRÉATION COMMANDE UPDATE_ALL v7.4")
print("="*60)
...
command_data = {
    ...
    "Title": f"UPDATE_ALL_v7.4_{datetime.now().strftime('%Y%m%d_%H%M%S')}",
...
try:
    ...
    if response.status_code in [200, 201]:
        ...
        print("\n🎯 Les agents vont détecter cette commande dans 1-2 minutes")
        print("   et se mettre à jour automatiquement vers v7.4")
        print("   Les logs complets seront visibles dans SharePoint Documents")
    else:
