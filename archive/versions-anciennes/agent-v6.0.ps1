# ATLAS Agent v6.0 - Test Rollback avec Fix Heartbeat
$version = "6.0"
...
Write-Log "[v6.0] Version de test pour vérifier création tâche rollback" "UPDATE"
...
function Send-Heartbeat {
    try {
        ...
        $data = @{
            ...
            CPUPercent = [int]$cpu
            # Note: MemoryUsedPercent n'existe pas dans SharePoint
